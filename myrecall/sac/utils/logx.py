...
from myrecall.sac.utils.serialization_utils import convert_json
...
class Logger:
    ...
    def __init__(
        ...
        self.output_dir = output_dir or f"./logs/results/{tasks}/{method}_{seed}"
        # self.output_dir = output_dir or f"./logs/intro_recall/{tasks}/{method}_{seed}"
